...
(20240419001, 'employee_onboarding', '人员入职审批流', '1.0', 1, 'personnel', 'system', NOW(), '{"form_schema":[{"name":"employeeName","label":"姓名","type":"text","required":true,"placeholder":"请输入员工姓名","group":"基本信息"},{"name":"gender","label":"性别","type":"select","required":true,"options":[{"label":"男","value":"male"},{"label":"女","value":"female"}],"group":"基本信息"},{"name":"phone","label":"手机号","type":"text","required":true,"placeholder":"请输入手机号","group":"基本信息"},{"name":"email","label":"邮箱","type":"text","required":false,"placeholder":"请输入邮箱","group":"基本信息"},{"name":"education","label":"学历","type":"select","required":true,"options":[{"label":"初中","value":"junior_high"},{"label":"高中","value":"high_school"},{"label":"中专","value":"secondary"},{"label":"大专","value":"associate"},{"label":"本科","value":"bachelor"},{"label":"硕士","value":"master"},{"label":"博士","value":"doctoral"}],"group":"教育背景"},{"name":"university","label":"就读大学","type":"text","required":true,"placeholder":"请输入毕业院校名称","group":"教育背景"},{"name":"departmentId","label":"入职部门","type":"select","required":true,"placeholder":"请选择入职部门","dynamicOptions":"department","group":"入职岗位信息"},{"name":"position","label":"入职岗位","type":"select","required":true,"placeholder":"请选择岗位","dynamicOptions":"post","group":"入职岗位信息"},{"name":"employeeType","label":"员工性质","type":"select","required":true,"options":[{"label":"正式","value":"regular"},{"label":"实习","value":"intern"},{"label":"外包","value":"outsourced"}],"group":"入职岗位信息"},{"name":"startDate","label":"入职日期","type":"date","required":true,"group":"入职岗位信息"},{"name":"description","label":"备注","type":"textarea","required":false,"placeholder":"请输入备注信息","rows":3,"group":"补充说明"}]}');
