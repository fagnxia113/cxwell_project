...
export class ProjectService {
  ...
  async updateProject(id: bigint, data: any) {
    const updateData: any = {
        ...
        airCooledPower: data.air_cooled_power,
        airCooledCabinets: data.air_cooled_cabinets,
        liquidCooledPower: data.liquid_cooled_power,
        liquidCooledCabinets: data.liquid_cooled_cabinets,
  ...
  private mapProject(project: any) {
    return {
      ...
      air_cooled_power: project.airCooledPower,
      air_cooled_cabinets: project.airCooledCabinets,
      liquid_cooled_power: project.liquidCooledPower,
      liquid_cooled_cabinets: project.liquidCooledCabinets,
