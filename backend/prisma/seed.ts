...
async function main() {
  ...
  const roles = [
    ...
    { id: 3n, name: '人事主管', key: 'hr_manager', sort: 3, scope: '1' },
    { id: 4n, name: '员工', key: 'user', sort: 4, scope: '5' },
    { id: 5n, name: '项目经理', key: 'project_manager', sort: 5, scope: '2' },
  ...
  const policies = [
    ...
    { ptype: 'p', v0: 'role:hr_manager', v1: 'menu:workflow', v2: 'allow' },
    { ptype: 'p', v0: 'role:hr_manager', v1: 'menu:personnel', v2: 'allow' },
    { ptype: 'p', v0: 'role:hr_manager', v1: 'menu:organization', v2: 'allow' },
    { ptype: 'p', v0: 'role:hr_manager', v1: 'menu:knowledge', v2: 'allow' },
    { ptype: 'p', v0: 'role:hr_manager', v1: 'menu:admin', v2: 'allow' },
    ...
    { ptype: 'p', v0: 'role:project_manager', v1: 'menu:workflow', v2: 'allow' },
    { ptype: 'p', v0: 'role:project_manager', v1: 'menu:personnel', v2: 'allow' },
    { ptype: 'p', v0: 'role:project_manager', v1: 'menu:knowledge', v2: 'allow' },
    { ptype: 'p', v0: 'role:project_manager', v1: 'workflow:create', v2: 'allow' },
    { ptype: 'p', v0: 'role:project_manager', v1: 'project:*', v2: 'allow' },
    { ptype: 'p', v0: 'role:project_manager', v1: 'knowledge:view', v2: 'allow' },
    ...
    { ptype: 'p', v0: 'role:user', v1: 'menu:workflow', v2: 'allow' },
    { ptype: 'p', v0: 'role:user', v1: 'menu:knowledge', v2: 'allow' },
    { ptype: 'p', v0: 'role:user', v1: 'workflow:create', v2: 'allow' },
    { ptype: 'p', v0: 'role:user', v1: 'project:view', v2: 'allow' },
    { ptype: 'p', v0: 'role:user', v1: 'knowledge:view', v2: 'allow' },
  ];
