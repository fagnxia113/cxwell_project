...
const PositionPage: React.FC = () => {
  ...
  const loadData = async () => {
    try {
      ...
      const [posRes, deptRes] = await Promise.all([
        apiClient.get<any>(API_URL.ORGANIZATION.POSITIONS),
        apiClient.get<any>(API_URL.ORGANIZATION.DEPARTMENTS)
      ])
  ...
  }, [positions, filterDept, searchTerm, sortBy])
              ...
              >
                ...
                <div className="col-span-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] font-black text-slate-600 uppercase tracking-wide">{pos.department_name || 'Global'}</span>
                  </div>
                </div>
