export interface FormField {
  name: string
  label: string
  type: 'text' | 'number' | 'select' | 'date' | 'datetime' | 'file' | 'user' | 'department' | 'textarea' | 'array' | 'currency' | 'phone' | 'email' | 'checkbox' | 'radio' | 'reference' | 'lookup' | 'images' | 'files' | 'project' | 'warehouse' | 'customer' | 'supplier' | 'position'
  required?: boolean
  options?: any[]
  defaultValue?: any
  placeholder?: string
  ...
  dynamicOptions?: 'department' | 'position' | 'employee' | 'project' | 'warehouse' | 'customer' | 'supplier' | 'user'
