// API配置
// 开发环境：使用空字符串，通过Vite代理转发到后端
// 生产环境：使用 VITE_API_BASE_URL 环境变量指定后端地址
...
export const API_URL = {
  ...
  WORKFLOW: {
    ...
    MONITORING: `${API_BASE_URL}${API_PATHS.WORKFLOW}/monitoring`,
  },
  ORGANIZATION: {
  ...
  EQUIPMENT: {
    ...
    STATISTICS: `${API_BASE_URL}/api/equipment/statistics`,
  },
  NOTIFICATIONS: {
  ...
  PERMISSIONS: {
    ...
    ME: `${API_BASE_URL}/api/auth/permissions/me`,
    ...
    PERMISSIONS: `${API_BASE_URL}/api/permissions/permissions`,
    PERMISSIONS_BY_MODULE: `${API_BASE_URL}/api/permissions/permissions/by-module`,
    SAVE_ROLE: `${API_BASE_URL}/api/permissions/roles`,
    UPDATE_ROLE: (code: string) => `${API_BASE_URL}/api/permissions/roles/${code}`,
    ROLE_PERMISSIONS: (code: string) => `${API_BASE_URL}/api/permissions/roles/${code}/permissions`,
    ROLE_DATA_SCOPES: (code: string) => `${API_BASE_URL}/api/permissions/roles/${code}/data-scopes`,
    DELETE_ROLE: (code: string) => `${API_BASE_URL}/api/permissions/roles/${code}`,
    ASSIGN_USER_ROLE: (userId: string, roleCode: string) => `${API_BASE_URL}/api/permissions/users/${userId}/roles/${roleCode}`,
    REMOVE_USER_ROLE: (userId: string, roleCode: string) => `${API_BASE_URL}/api/permissions/users/${userId}/roles/${roleCode}`,
  },
  PROJECTS: {
    ...
    STATISTICS: `${API_BASE_URL}${API_PATHS.PROJECTS}/statistics`,
  },
  WORK_TIME: {
